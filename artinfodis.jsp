...
<div id="content">
       ...
       ResultSet rs=null;
       String aaid;
        aaid=request.getParameter("id");
            st=con.createStatement();
           rs=st.executeQuery("select * from artist where aid='"+aaid+"'");
           while(rs.next())
            {
              String fname=rs.getString("firstname");
              String mname=rs.getString("middlename");
               String lname=rs.getString("Lastname");%>
              </br> <h2><%out.println(fname+" "+mname+" "+lname);%></h2> 
             <% 
               ...
               <%out.println("Email:"+email);%></br>
                ...
                <%out.println(dis);%>
                <img src="pics/<%=pic%>"width="100" height="100"/>
                 <a href=<%="\"awinfodis.jsp?id="+aaid+"\""%>>View Artwork</a>
