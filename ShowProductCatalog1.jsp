        ...
        <div id="tooplate_sidebar">
            ...
            <div id="menu">
               <ul class="navigation">
                ...
                <li><a href="/Trial/ShowProductCatalog1.jsp" class="selected">Artwork Catalog</a></li>
...
// Initialize the array of available products.
    Item[] catalog = new Item[] {
        new Item("X-1", "AWariel18", 5500.00, 1),
        new Item("GWU-123876345-27B/6",
            "AWariel9", 21000.00, 1),
        new Item("BCT-12", "AWdav1",  6500.00, 1),
        new Item("EZ-1", "AWdav10 ",
            6600.00, 1),
        new Item("PF-101", "AWdav19", 15000.00 , 1),
        new Item("LOD-7", "AWivory11",22000.00 , 1),
        new Item("X-1", "AWAriel0",5600.00 , 1),
        new Item("GWU-123876345-27B/6",
            "AWivory2", 7400.00, 1),
        new Item("BCT-12", "AWivory20",19500.00 , 1),
        new Item("EZ-1", "AWlilac12 ",
            17600.00, 1),
        new Item("PF-101", " AWlilac21",20850.00 , 1),
        new Item("LOD-7", "AWlilac3",9880.00 , 1),
         new Item("X-1", "AWlilly13",9500.00 , 1),
        new Item("GWU-123876345-27B/6",
            "AWlilly22",19780.00 , 1),
        new Item("BCT-12", "AWlilly4",15950.00 , 1),
        new Item("EZ-1", "AWmac14",
            19640.00, 1),
        new Item("PF-101", "AWmac23 ", 11950.00, 1),
        new Item("LOD-7", "AWmac5",6000.95 , 1),
        new Item("X-1", " AWmerci15",  13000.00 , 1),
        new Item("GWU-123876345-27B/6",
            "AWmerci24",17650.00, 1),
        new Item("BCT-12", "AWmerci6", 21000.00, 1),
        new Item("EZ-1", "AWpaul16",
            5500.00, 1),
        new Item("PF-101", "AWpaul25",8900.00 , 1),
        new Item("LOD-7", " AWpaul7 ",19800.00 , 1),
        new Item("EZ-1", "AWwaydal8",
            16700.00, 1),
        new Item("PF-101", "AWwaydal26", 14560.00, 1),
        new Item("LOD-7", "AWwaydal17  ",9000, 1)
