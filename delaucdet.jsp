<%-- 
    Document   : delaucdet
    Created on : 3 Nov, 2017, 9:31:43 PM
    Author     : brunda
--%>
...
Your ArtWork is Successfully sold!!
<%
String id=request.getParameter("id");
try {
Class.forName("com.mysql.jdbc.Driver").newInstance();
Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/trial","root","root");
String query = "select * from auctiondetail where art_id='"+id+"'";
Statement st = conn.createStatement();
st.executeUpdate("DELETE FROM auctiondetail WHERE art_id='"+id+"'");
}
catch(Exception e){}
%> </div>
</div> <!-- end of scroll -->
