<%-- 
    Document   : fredit
    Created on : 1 Nov, 2017, 9:01:02 PM
    Author     : brunda
--%>
...
em { color: #ab6700; }
    ...
    <body>
       <br><br>
       <form method="get" action="updfr.jsp">
<table border="1">
<tr><th>Frame ID</th><th>Name</th><th>Size</th><th>Type</th><th>Cost</th><th>Colors</th><th>Image</th></tr>
<%  String id=request.getParameter("id");
    Class.forName("com.mysql.jdbc.Driver").newInstance();
        java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/trial","root","root");
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery("select * from frame where fid='"+id+"'");
        while(rs.next())
        {
        %>
<tr>
<td><input type="text" name="fid" value="<%=rs.getString(1)%>"></td>
<td><input type="text" name="name" value="<%=rs.getString(2)%>"></td>
<td><input type="text" name="size" value="<%=rs.getString(3)%>"></td>
<td><input type="text" name="type" value="<%=rs.getString(4)%>"></td>
<td><input type="text" name="cost" value="<%=rs.getString(5)%>"></td>
<td><input type="text" name="col" value="<%=rs.getString(6)%>"></td>
<td><input type="text" name="fimg" value="<%=rs.getString(7)%>"></td>
</tr>
<tr>
