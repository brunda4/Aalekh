<%-- 
    Document   : artdis
    Created on : 14 Oct, 2017, 1:44:35 PM
    Author     : brunda
--%>
...
<div id="content">
        	  ...
        	  <div class="scrollContainer">
                <div class="panel" id="home">
                	...
                	<h2>Our Artist</h2> 
        <form method="get" action="asearch.jsp">
        <input type="text" name="asearch">&nbsp;<input type="submit" value="Search"></br></br>
        </form>
        <form method="post">
        ...
        try{
            ...
            while(rs.next())
            {
              ...
              <img src="pics/<%=rs.getString("pic")%>" width="100" height="100"/></br></br>
                <a href=<%="\"artinfodis.jsp?id="+aaid+"\""%>>View</a>
                </br></br>
               <% out.println("--------------------------------------------------------------------------------"); %>
           </br><% }
        }
