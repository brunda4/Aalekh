<%-- 
    Document   : uartist
    Created on : 1 Nov, 2017, 11:57:49 AM
    Author     : brunda
--%>
...
<html>
    <head>
        ...
        <title>updating artist</title>  <style>
           /* 
rtiwood
...
<td><a href=<%="\"editartist.jsp?id="+rs.getString("aid")+"\""%>><input type="button" name="edit" value="Edit" style="background-color:#49743D;font-weight:bold;color:#ffffff;"></a></td>
<td><a href=<%="\"delartist.jsp?id="+rs.getString("aid")+"\""%>><input type="button" name="delete" value="Delete" style="background-color:#ff0000;font-weight:bold;color:#ffffff;"></a></td>
</tr>
<%
}
%>
