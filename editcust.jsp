<%-- 
    Document   : editcust
    Created on : 1 Nov, 2017, 3:30:41 PM
    Author     : brunda
--%>
...
<html>
    <head>
        ...
        <title>Edit customers</title><style>
           /* 
...
em { color: #ab6700; }
    ...
    <body>
        <form method="get" action="updcust.jsp">
       <br><br>
<table border="1">
<tr><th>UserID</th><th>Password</th><th>FirstName</th><th>MiddleName</th><th>LastName</th><th>Date of birth</th><th>Address</th><th>City</th><th>State</th><th>Country</th><th>Zipcode</th><th>Phone</th><th>Email</th><th>Gender</th></tr>
<%  String id=request.getParameter("id");
    Class.forName("com.mysql.jdbc.Driver").newInstance();
        java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/trial","root","root");
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery("select * from customer where userid='"+id+"'");
        while(rs.next())
        {
        %>
<tr>
<td><input type="text" name="uid" value="<%=rs.getString(1)%>"></td>
...
<td><input type="text" name="add" value="<%=rs.getString(7)%>"></td>
...
<td><input type="text" name="ph" value="<%=rs.getString(12)%>"></td>
<td><input type="text" name="em" value="<%=rs.getString(13)%>"></td>
<td><input type="text" name="gen" value="<%=rs.getString(14)%>"></td>
</tr>
<tr>
