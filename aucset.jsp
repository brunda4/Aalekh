<%-- 
    Document   : aucset
    Created on : 29 Oct, 2017, 8:02:40 PM
    Author     : brunda
--%>
...
.btn_more a {
    ...
    <a href="aucset.jsp" class="selected">Set Auction</a>
          ...
          <div id="content">
        	  ...
        	  <div class="scrollContainer">
                <div class="panel" id="home">
                	...
                	<h2>Set Auction</h2> 
<form method="get" action="aucsetsql.jsp" enctype="multipart/form-data" >
    <label>ArtworkID:&nbsp</label><input type="text" name="artid" required>
</br></br>
<label>Upload art work:&nbsp</label><input type="file" name="aimg" accept="image/*" required>
</br></br>
<label>Start Date:&nbsp</label><input type="date" name="sdate" placeholder="yyyy-mm-dd">
</br></br>
<label>End Date:&nbsp</label><input type="date" name="edate" placeholder="yyyy-mm-dd">
</br></br>
<label>GovtPrice:&nbsp</label><input type="text" name="gcost" placeholder="Government Price" required>
</br></br>
