<%-- 
    Document   : adminlogin
    Created on : 5 Oct, 2017, 3:17:15 PM
    Author     : brunda
--%>
...
.col_280 { width: 280px; }
    ...
    <div id="tooplate_wrapper">
        ...
        <div id="tooplate_sidebar">
            ...
            <div id="menu">
               <ul class="navigation">
                    <li><a href="adminlogin.jsp" class="selected">Admin</a></li>
                    <li><a href="artlogin.jsp" >Artist</a></li>
                    <li><a href="custlogin.jsp" class="last">User</a></li>
                </ul>
            </div>
            </div>
         <div id="content">
...
<form method="post" action="admincontr.jsp">
<input type="text" name="uname" placeholder="username"/></br></br>
<input type="password" name="pwd" placeholder="password"/></br></br>
<input type="submit" value="login">
<input type="reset" value="clear"></br></br>
</form>
<a href="artreg.jsp">Register</a>
</div>
                      </div>
</div> <!-- end of scroll -->
		</div>
