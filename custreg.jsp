...
return false;
            ...
            if(
document.getElementById("z").value.length!>5)
{
 alert("Please provide password with 6 or more characters!");
document.getElementById("pass").focus();
return false;
...
em { color: #ab6700; }
    ...
    <div id="tooplate_wrapper">
        ...
        <div id="tooplate_sidebar">
            ...
            <div id="menu">
               <ul class="navigation">
                    <li><a href="artreg.jsp">Artist</a></li>
                    <li><a href="custreg.jsp" class="selected" class="last">User</a></li>
                </ul>
            </div>
       </div>
  <div id="content">
...
<form method="get" action="custregsql.jsp" onsubmit="return(validate());" >
        <label>UserID:&nbsp</label><input type="text" name="uuname" placeholder="Username" required>
</br></br>
<label>PASSWORD:&nbsp</label><input id="pass" type="password" name="ppwd" placeholder="password" required>
</br></br>
...
<label>LAST NAME:&nbsp</label><input type="text" name="lname" placeholder=" Last name" required>
</br></br>
<label> Date of birth:&nbsp</label><input type="date" name="dob" placeholder="yyyy-mm-dd" required>
</br></br>
<label> Address line 1:&nbsp</label><input type="text" name="address1" placeholder="Line 1" required>
</br></br>
<label> City:&nbsp</label><input type="text" name="city" placeholder="City" required>
</br></br>
<label> State:&nbsp</label><input type="text" name="state" placeholder="State" required>
</br></br>
<label> Country:&nbsp</label><input type="text" name="country" placeholder="Country"required>
</br></br>
<label> Zipcode:&nbsp</label><input id="z" type="text" name="zip" placeholder="Minimum 5 characters" required>
</br></br>
<label>Phone No:&nbsp</label><input type="text" name="phno" placeholder="Mobile" required>
</br></br>
