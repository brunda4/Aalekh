<%-- 
    Document   : fsearch
    Created on : 5 Nov, 2017, 7:16:23 PM
    Author     : brunda
--%>
...
<div id="content">
        ...
        <%String frame=request.getParameter("fsearch");
        ...
        try{
            ...
            rs=st.executeQuery("select * from frame where name='"+frame+"'");
            while(rs.next())
            {
               ...
               <a href="ShowProductCatalog.jsp"> <button>Buy frame</button></a></br></br></br></br>
                <%
            }
        }
        catch(Exception e)
