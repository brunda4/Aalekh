<%-- 
    Document   : uframe
    Created on : 1 Nov, 2017, 8:56:11 PM
    Author     : brunda
--%>
...
<td><a href=<%="\"fredit.jsp?id="+rs.getString(1)+"\""%>><input type="button" name="edit" value="Edit" style="background-color:#49743D;font-weight:bold;color:#ffffff;"></a></td>
<td><a href=<%="\"delfr.jsp?id="+rs.getString(1)+"\""%>><input type="button" name="delete" value="Delete" style="background-color:#ff0000;font-weight:bold;color:#ffffff;"></a></td>
</tr>
<%
}
%>
