<%-- 
    Document   : artinfodis
    Created on : 14 Oct, 2017, 3:05:09 PM
    Author     : brunda
--%>
...
<div id="content">
        ...
        ResultSet rs1=null;
        ResultSet rs3=null;
        String tname=request.getParameter("id");%>
        </br> <h2><%out.println(tname);%></h2><%
            ...
            String mname="";
            String lname="";
            rs=st.executeQuery("select * from genre where name='"+tname+"'");
            String gid="";
            while(rs.next())
            {
                gid=rs.getString("gid");
            }
            rs1=st1.executeQuery("select * from artwork where type='"+gid+"'");
            while(rs1.next())
            {
              ...
              String artid=rs1.getString("art_id");
               ...
               <%out.println("Size:"+size);%></br>
                ...
                <%out.println(des);
                %></br></br><a href="ShowProductCatalog1.jsp">Buy</a></br></br>
                 <a href=<%="\"artinfodis.jsp?id="+aid+"\""%>>View Artist</a>
                </br></br>
               <% out.println("--------------------------------------------------------------------------------"); 
            }
        %> </div>
