<%-- 
    Document   : exhadd
    Created on : 1 Nov, 2017, 5:26:26 PM
    Author     : brunda
--%>
...
<form method="get" action="exhaddsql.jsp" enctype="multipart/form-data" >
...
<label>ArtistID:&nbsp</label><input type="text" name="aid"  required>
</br></br>
