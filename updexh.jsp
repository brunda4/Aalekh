<%-- 
    Document   : updexh
    Created on : 1 Nov, 2017, 4:59:46 PM
    Author     : brunda
--%>
...
<html>
    <head>
        ...
        <title>updating exhibition</title>
        <style>
           /* 
rtiwood
...
<tr><th>Exh_no</th><th>Location</th><th>ArtistID</th><th>Number of artworks</th><th>StartDate</th><th>End date</th></tr>
...
<td><a href=<%="\"exhedit.jsp?id="+rs.getString(1)+"\""%>><input type="button" name="edit" value="Edit" style="background-color:#49743D;font-weight:bold;color:#ffffff;"></a></td>
<td><a href=<%="\"delexh.jsp?id="+rs.getString(1)+"\""%>><input type="button" name="delete" value="Delete" style="background-color:#ff0000;font-weight:bold;color:#ffffff;"></a></td>
</tr>
<%
}
%>
