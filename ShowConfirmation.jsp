<%-- 
    ...
    Created on : 3 Nov, 2017, 2:06:54 PM
    Author     : brunda
--%>
   ...
   <body bgcolor="#ffffff">
    ...
    <div id="tooplate_wrapper">
        ...
        <div id="tooplate_sidebar">
            ...
            <div id="menu">
               <ul class="navigation">
                    <li><a class="selected">ThankYou</a></li>
                    <li><a  href="Aalekhhome.jsp" class="last">Home</a></li>
                </ul>
                    </div>
            </div>
<div id="content">
...
int rn=generateRandomNumber(1000,8888);
%>
<h2>order submitted successfully!</h2>
<p>Thank you for your order.Your order confirmation number is:<em><%=rn%></em>
            <br>
        ...
        st.executeUpdate("update checkout set confirm_num='"+rn+"' where creditCardNumber='"+ccn+"'");
