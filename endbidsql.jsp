<%-- 
    Document   : endbidsql
    Created on : 3 Nov, 2017, 12:43:26 PM
    Author     : brunda
--%>
...
em { color: #ab6700; }
   ...
   <div id="content">
        ...
        <form method='get' action='delaucdet.jsp'>
       <br><br>
       <table>
<%  String id=request.getParameter("id");
    Class.forName("com.mysql.jdbc.Driver").newInstance();
        ...
        ResultSet rs=st.executeQuery("select * from auctiondetail where bidamt=(select max(bidamt) from auctiondetail where art_id='"+id+"')");
        st1.executeUpdate("DELETE FROM auction where art_id='"+id+"'");
        while(rs.next())
        {
         %>The Highest bidder for your artwork <input type='text' name='id' value='<%out.print(rs.getString(1));%>'> is:
        <tr>
            <td><%=rs.getString(2)%></td>
            <td>with the highest bid of Rs.</td>
            <td><%=rs.getString(3)%></td></tr>
        <tr><td><input type="submit" name="edit" value="SELL" style="background-color:#49743D;font-weight:bold;color:#ffffff;"></td>
</tr>
