<%-- 
    Document   : endbid
    Created on : 3 Nov, 2017, 12:36:05 PM
    Author     : brunda
--%>
...
td{
    ...
    <a href="aucset.jsp" >Set Auction</a>
     <a href="endbid.jsp" class="selected">My Auction</a> 
   ...
   <div id="content">
        	  ...
        	  <div class="scrollContainer">
                <div class="panel" id="home">
                	...
                	<h2>My Auction</h2> 
        <form method="get" action="endbidsql.jsp">
       <br><br>
      <% String aid=(String)session.getAttribute("name");%>
<table border="1">
    <tr><th>Artist ID</th><th>Art ID</th><th>Date Begin</th><th>Date End</th><th>Govt Rate</th><th>Image</th></tr>
<%Class.forName("com.mysql.jdbc.Driver").newInstance();
        java.sql.Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/trial","root","root");
        Statement st=con.createStatement();
        ResultSet rs=st.executeQuery("select * from auction where aid='"+aid+"'");
        while(rs.next())
        {
        %>
        <tr>
...
<td><input type="submit" name="bid" value="EndBid" style="background-color:#ff0000;font-weight:bold;color:#ffffff;"></td>
</tr>
<%
}
%></form>
